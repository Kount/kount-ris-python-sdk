...
class Payment(object):
	...
	def __init__(self, payment_token=None, payment_type=None, khashed=False):
		...
		Calculate and set the payment token LAST4 value. last4 - Last 4 characters of payment token"""
		self.last4 = "NONE"
...
class GiftCardPayment(Payment):
	...
	def __init__(self, gift_card_number):
		super(GiftCardPayment, self).__init__(payment_type="GIFT", payment_token=str(gift_card_number))
...
class GreenDotMoneyPakPayment(Payment):
    ...
    def __init__(self, green_dot_mp_payment_id):
        super(GreenDotMoneyPakPayment, self).__init__(payment_type="GDMP",

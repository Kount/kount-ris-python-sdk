...
class Response(object):
    ...
    def __init__(self, params):
        ...
        "DEVICE_LAYERS" - Get a string representing the five layers
			(Operating System, SSL, HTTP, Flash, JavaScript) of the remote device.
        ...
        "FLASH" - Get a string representing whether or not the remote device allows flash.
			return "Y" or "N"
        ...
        "COOKIES" - Get a string representing whether the remote device allows cookies
			return "Y" or "N"
        "MOBILE_DEVICE" - Get a string representing whether the remote device is a mobile device.
			return "Y" or "N"

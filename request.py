...
class Request(object):
    ...
    def merchant_acknowledgment_set(self, ma_type):
        ...
        The MACK field must be set as MERCHANTACKNOWLEDGMENT.TRUE if personal data is to be
    ...
    def payment_set(self, payment):
        ...
        """
        if "PENC" in self.params and not (isinstance(payment, NoPayment)) and not payment.khashed:
            try:
        ...
        print('payment_set - payment.last4', payment.last4)
